...
for word, count in word_counts.most_common(): #цикл,который выводит сначала самые встречаемые слова
    ...
    print(word, count, f"{p:.3f}%") #выводим, но в процентах оставляем только 3 знака после запятойэ
